...
The console command `voice.record.local` uses the same functions described above. Its source code also shows how to use the recording system in C++ without the premade recording functions.
...
The console command `voice.record.remote` uses the same functions described above. Its source code also shows how to use the recording system in C++ without the premade recording functions.

...
Opus and RNNoise do not run on the game thread to save on game thread time. So cpu cost of opus complexity and noise suppression with RNNoise are less relevant.
:::
...
Opus encoding does not run on the game thread, meaning you don't have to worry much about your game thread times.

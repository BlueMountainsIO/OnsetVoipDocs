...
This plugin enables you to build systems like phones, walkie talkies, global voice and team voice chats with two-dimensional (2D) voice through the use of voice channels. Voice channels are a server side routing system. Clients do not manage voice channel membership. The server decides who should receive voice data.
...
:::note
By default, shared 2D voice channels have priority over proximity and are played once in 2D. But this behaviour can be altered in `UOnsetVoipTalker`:

...
3. Please ensure that any other voice plugins/systems are removed including configuration!
2. Open your project, go to **Edit** -> **Plugins**, and search for `Onset VoIP`. Enable the plugin and close the editor.

...
Format is raw 32 bit float PCM, 24 kHz mono.

## Capturing `UOnsetVoipTalker` voice data

You can intercept audio from other players in BP and C++ with the following delegates. These are also internally used for the recording feature.
